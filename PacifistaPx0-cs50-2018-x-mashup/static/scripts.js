// I got lots of help from Stackexchange and  CS50 Reddit on this Javascript.
...
function addMarker(place)
{
    ...
    var marker = new google.maps.Marker({
        ...
        draggable: true,
        raiseOnDrag: true,
        title: `${place.place_name}, ${place.admin_code1}`, // this adds the name of the place anf the admin code1 from SQL table to the marker
        label: {
...
{
    // Iterate over marker array and delete them
    for (var i; i < markers.length; i++){
        markers[i].setmap(null);
    }

    // reset global variable markers
    markers = [];
}
